...
def baseplot(plotname):
	...
	plt.plot(X[0],Y[0],color='black',linewidth=2)
	plt.scatter(tickx+0.02,ticky,marker=0,c='black',linewidth=2)
	for i in range(0,10):
...
def circles(X,Y,size,color,plotname):
	
	fig=baseplot(plotname)
	plt.scatter(X,Y,s=size,c='white',alpha=0.7,linewidth=1.5,edgecolor='black')
	
	# legend
	plt.scatter (0.3,0.9,s=40,c='white',linewidth=1.5,edgecolor='black')
	plt.scatter (0.4,0.9,s=50,c='white',linewidth=1.5,edgecolor='black')
	plt.scatter (0.5,0.9,s=60,c='white',linewidth=1.5,edgecolor='black')
	plt.scatter (0.6,0.9,s=70,c='white',linewidth=1.5,edgecolor='black')
	plt.scatter (0.7,0.9,s=80,c='white',linewidth=1.5,edgecolor='black')
